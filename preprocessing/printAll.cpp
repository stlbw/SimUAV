...
void printBat(BatteryDB db, string dbName, char switchCase) {
    if (switchCase == '1' || switchCase == '2' || switchCase == '3') {
        ...
        cout << "" << endl;
        cout << left << setw(50) << "CAPACITA' NOMINALE [mAh]" << left << setw(25) << db.C << endl;
        cout << left << setw(50) << "RENDIMENTO DI SCARICA" << left << setw(25) << db.mu << endl;
        cout << "" << endl;
...
void printEn(EngineDB db, string dbName, char switchCase) {
    if (switchCase == '1' || switchCase == '2'|| switchCase == '3') {
        ...
        cout << "" << endl;
        cout << left << setw(50) << "NUMERO DI GIRI MINIMO DEL MOTORE  [rpm]" << left << setw(25) << db.laps_min
             << endl;
        cout << left << setw(50) << "NUMERO DI GIRI MASSIMO DEL MOTORE [rpm] SENZA CARICO" << left << setw(25)
             << db.laps_max << endl;
        cout << left << setw(50) << "NOMINAL VOLTAGE" << left << setw(25) << db.nominal_voltage << endl;
        cout << left << setw(50) << "NO LOAD CURRENT" << left << setw(25) << db.no_load_current << endl;
        cout << left << setw(50) << "STALL CURRENT" << left << setw(25) << db.stall_current << endl;
        cout << left << setw(50) << "STALL TORQUE" << left << setw(25) << db.stall_torque << endl;
        cout << "" << endl;
